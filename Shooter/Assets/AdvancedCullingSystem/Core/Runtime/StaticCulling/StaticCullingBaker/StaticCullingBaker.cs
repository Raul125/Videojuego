...
namespace NGS.AdvancedCullingSystem.Static
{
    public partial class StaticCullingBaker : IDisposable
    {
        ...
        private NativeParallelHashMap<int, UnsafeList<int>> _cellTargetsMap;
        ...
        public StaticCullingBaker(GeometryTree geometryTree)
        {
            ...
            _cellTargetsMap = new NativeParallelHashMap<int, UnsafeList<int>>(_geometryTreeStruct.Length, Allocator.Persistent);
